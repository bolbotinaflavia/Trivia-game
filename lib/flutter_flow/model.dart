...
Widget wrapWithModel<T extends MyAppModel>({
  required T model,
...
T createModel<T extends MyAppModel>(
...
abstract class MyAppModel<W extends Widget> {
...
class MyAppDynamicModels<T extends MyAppModel> {
  MyAppDynamicModels(this.defaultBuilder);
