...
class MyAppIconButton extends StatefulWidget {
  ...
  @override
  State<MyAppIconButton> createState() => _MyAppIconButtonState();
}

class _MyAppIconButtonState extends State<MyAppIconButton> {
  bool loading = false;
  ...
  @override
  void didUpdateWidget(MyAppIconButton oldWidget) {
